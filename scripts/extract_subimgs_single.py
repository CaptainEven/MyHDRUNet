...
def main():
    ...
    :return:
    """
    input_folder = '/mnt/diskc/even/Ldr2HdrData/gt'
    save_folder = '/mnt/diskc/even/Ldr2HdrData/gt_sub'

    n_thread = 10  # number of threads
...
def worker(path, save_folder, crop_sz, step, thres_sz, compression_level):
    ...
    for x in h_space:
        for y in w_space:
            ...
            cv2.imwrite(os.path.join(save_folder, img_name.replace('.png', '_s{:03d}.png'.format(index))),
                        crop_img,
